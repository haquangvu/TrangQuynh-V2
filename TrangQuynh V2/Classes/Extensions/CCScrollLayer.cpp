...
//        printf("m_uCurrentScreen : %d", m_uCurrentScreen);
	}
...
//        CCLOG("%f, %f", this->getRectLayer().size.width, this->getRectLayer().size.height);
        
//        if(!this->getRectLayer().containsPoint(touchPoint)){
//            m_pScrollTouch = NULL;
//            return false;
//        }
